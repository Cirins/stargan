...
if __name__ == '__main__':
    ...
    parser.add_argument('--min_g_lr', type=float, default=1e-6, help='learning rate decay for G')
    parser.add_argument('--min_d_lr', type=float, default=1e-6, help='learning rate decay for D')
    parser.add_argument('--num_iters_decay', type=int, default=100000, help='number of iterations with constant learning rate')
